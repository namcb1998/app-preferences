...
var AppPreferences = (function (_super) {
    ...
    /**
       ...
       * @return {Promise<any>} Returns a promise
       */
    AppPreferences.prototype.fetch = /**
       * Get a preference value
       *
       * @param {string} dict Dictionary for key (OPTIONAL)
       * @param {string} key Key
    ...
    /**
       ...
       * @return {Promise<any>} Returns a promise
       */
    AppPreferences.prototype.store = /**
       * Set a preference value
       *
       * @param {string} dict Dictionary for key (OPTIONAL)
       * @param {string} key Key
    ...
    /**
       ...
       * @return {Promise<any>} Returns a promise
       */
    AppPreferences.prototype.remove = /**
       * Remove value from preferences
       *
       * @param {string} dict Dictionary for key (OPTIONAL)
       * @param {string} key Key
    ...
    /**
       ...
       * @return {Promise<any>} Returns a promise
       */
    AppPreferences.prototype.clearAll = /**
       * Clear preferences
       *
       * @return {Promise<any>} Returns a promise
       */
    ...
    /**
       ...
       * @return {Observable<any>} Returns an observable
       */
    AppPreferences.prototype.watch = /**
       * Show native preferences interface
       *
       * @param {boolean} subscribe true value to subscribe, false - unsubscribe
       * @return {Observable<any>} Returns an observable
    ...
    /**
       ...
       * @returns {Object} Custom object, bound to that suite
       */
    AppPreferences.prototype.cloudSync = /**
       * Return cloud synchronized configuration context
       * Currently supports Windows and iOS/macOS
       * @returns {Object} Custom object, bound to that suite
       */
    ...
    /**
       ...
       * @returns {Object} Custom Object, bound to that suite
       */
    AppPreferences.prototype.defaults = /**
       * Return default configuration context
       * Currently supports Windows and iOS/macOS
       * @returns {Object} Custom Object, bound to that suite
       */
